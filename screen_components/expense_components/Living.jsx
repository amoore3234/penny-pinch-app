...
export const Living = ({ navigation }) => {
    ...
    return(
        <SafeAreaView>
            <View style={styles.LivingBorder}>
                <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
                    <TextInput
                        onFocus={handleFocusName}
                        onBlur={handleBlurName}
                        style={[styles.InputStyle, {borderColor: isFocusedName ? '#690BF8' : '#807f7d'}]}
                    ...
                    <FakeCurrencyInput
                        ...
                        style={[styles.InputStyle, {borderColor: isFocused ? '#690BF8' : '#807f7d'}]}
                        prefix="$ "
                        delimiter=","
                        separator="."
                        precision={2}
                ...
                <View style={{flexDirection: 'row', justifyContent:'space-around', paddingTop: 15}}>
                    <TouchableHighlight
                        ...
                        disabled={addLivingName === "" ? true : false}
                    ...
                    <CenterElements>
                        <RoundedBorderExp>
                            <View style={styles.ItemViewStyle}>
                                <Text style={styles.ItemStyle}>{item.livingName}</Text>
                                <Text style={styles.ItemStyle}>{formatNumber(item.livingCost, {delimiter: ",", prefix: "$", precision:2, separator: '.'})}</Text>
                            </View>
