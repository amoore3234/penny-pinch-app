...
export const CreditCard = ({ navigation }) => {
    ...
    <FlatList 
        ...
        <RoundedBorderExp>
            ...
            <Text style={{fontSize: 25, fontWeight: 'bold'}}>{item.cardName}</Text>
            <Text style={{fontSize: 25, fontWeight: 'bold'}}>{formatNumber(item.cardCost, {delimiter: ",", prefix: "$", precision:2, separator: '.'})}</Text>
            </View>
