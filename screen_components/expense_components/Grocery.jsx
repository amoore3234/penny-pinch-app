                ...
                <CenterElements>
                    <RoundedBorderExp>
                        <View style={styles.ItemViewStyle}>
                            <Text style={styles.ItemStyle}>{item.groceryName}</Text>
                            <Text style={styles.ItemStyle}>{formatNumber(item.groceryCost, {delimiter: ",", prefix: "$", precision:2, separator: '.'})}</Text>
                        </View>
